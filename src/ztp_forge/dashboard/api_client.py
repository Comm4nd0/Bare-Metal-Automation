"""
API client for the ZTP-Forge dashboard.
...
Usage:
    from ztp_forge.dashboard.api_client import DashboardClient
...
class DashboardClient:
    """HTTP client for pushing status updates to the ZTP-Forge dashboard API."""
